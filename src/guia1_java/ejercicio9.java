    ...
    public static void main(String[] args) {
        ...
        */
        ...
        while (!spesos.matches("\\d{1,}\\.\\d{2}")) {            
            System.out.println("Ingrese una cantidad de pesos Válido (ejemplo: 250.00 - 183.47) ");
            spesos = scn.nextLine();
        }
        ...
        System.out.println("Equivalente en Guaraníes: " + String.format("%.2f",guaranies) + " Gs");
        System.out.println("Equivalente en Reales: " + String.format("%.2f",reales) + " R$");
    }
}
